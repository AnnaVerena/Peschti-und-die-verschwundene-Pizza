...
public class OutisZimmer extends game.Map{
	...
	public OutisZimmer() throws MalformedURLException{
        ...
        mapEvents.add(new MapEvent(9, 13, Game.DOWN, null, false, null, new EventList( new Teleport(1, 4, 8, Game.DOWN), new WaitEvent(10))));
        mapEvents.add(new MapEvent(10, 13, Game.DOWN, null, false, null, new EventList( new Teleport(1, 4, 8, Game.DOWN), new WaitEvent(10))));
